...
<body>
    <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if ($product->image_url): ?>
                        <img src="<?php echo htmlspecialchars($product->image_url, ENT_QUOTES, 'UTF-8'); ?>" alt="Product Image" style="max-width: 200px;">
                    <?php endif; ?>
        ...
        <a href="/webbanhang/Product" class="btn btn-primary">Quay lại danh sách</a>
    </div>
